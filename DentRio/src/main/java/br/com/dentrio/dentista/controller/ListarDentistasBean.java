...
@ViewScoped
@ManagedBean
public class ListarDentistasBean extends BaseBean implements Serializable {
    ...
    public void limparFormDentista() {
	dentista = new Dentista();
    }

    public void deletarDentista() {
	entityManager.getTransaction().begin();
	dentistaService.deletarDentista(this.getDentistaSelecionado());
	entityManager.getTransaction().commit();
	carregarListaDentistas();
	addMessage("Sucesso", "Dentista excluído com sucesso!");
	limparFormDentista();
    }
